...
namespace PersonForm {
    ...
    public partial class PersonContextDataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PeopleRow AddPeopleRow(string FullName, System.DateTime BirthDate, string Email, string PhoneNumber) {
...
namespace PersonForm.PersonContextDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[People] WHERE (([Id] = @Original_Id) AND ([BirthDate] = @Origi" +
                "nal_BirthDate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[People] ([FullName], [BirthDate], [Email], [PhoneNumber]) VALU" +
                "ES (@FullName, @BirthDate, @Email, @PhoneNumber);\r\nSELECT Id, FullName, BirthDat" +
                "e, Email, PhoneNumber FROM People WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [FullName] = @FullName, [BirthDate] = @BirthDate, [Email] = @Email, [PhoneNumber] = @PhoneNumber WHERE (([Id] = @Original_Id) AND ([BirthDate] = @Original_BirthDate));
SELECT Id, FullName, BirthDate, Email, PhoneNumber FROM People WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PersonForm.Properties.Settings.Default.PersonContextConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FullName, BirthDate, Email, PhoneNumber FROM dbo.People";
        ...
        public virtual int Insert(string FullName, System.DateTime BirthDate, string Email, string PhoneNumber) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, System.DateTime BirthDate, string Email, string PhoneNumber, int Original_Id, System.DateTime Original_BirthDate, int Id) {
            if ((FullName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, System.DateTime BirthDate, string Email, string PhoneNumber, int Original_Id, System.DateTime Original_BirthDate) {
            return this.Update(FullName, BirthDate, Email, PhoneNumber, Original_Id, Original_BirthDate, Original_Id);
        }
    }
